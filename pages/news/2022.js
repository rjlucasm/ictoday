...
export default function News22() {
    ...
    <div className="container">
        ...
        <main className="main">
            ...
            <div className="pagescard">12/30 -&nbsp;
                <a href="https://www.cryptonewsz.com/internet-computer-turns-long-term-bearish-can-icp-reach-five-usd/" target="_blank" rel="noopener noreferrer">Internet Computer turns long-term bearish: Can ICP reach $5?</a>
            </div>
            ...
            <div className="pagescard">05/31 -&nbsp;
                <a href="https://medium.com/dfinity/the-internet-computer-for-ethereum-developers-3331b50db31b" target="_blank" rel="noopener noreferrer">The Internet Computer for Ethereum Developers</a>
            </div>
            ...
            <div className="pagescard">02/09 -&nbsp;
                <a href="https://stockstelegraph.com/icp-coin-still-struggling-to-become-bullish/" target="_blank" rel="noopener noreferrer">Internet Computer (ICP)  – Still Struggling to become Bullish</a>
            </div>
